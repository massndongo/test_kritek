 ...
 */
final class Version20220413014702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, date_facture DATE NOT NULL, number_invoce INT NOT NULL, customer_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invocelines DROP FOREIGN KEY FK_6E0696C0EED8DFC8');
